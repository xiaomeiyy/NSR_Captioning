...
class AttModel(CaptionModel):
    ...
    def _sample_beam(self, fc_feats, att_feats,box_logits, att_relscore,att_masks=None, opt={}):
        beam_size = opt.get('beam_size', 10)
        batch_size = fc_feats.size(0)

        p_fc_feats, p_att_feats, pp_att_feats, p_att_masks = self._prepare_feature(fc_feats, att_feats, box_logits, att_relscore, att_masks)
    ...
    def _sample(self,fc_feats, att_feats,box_logits, att_relscore, att_masks=None, opt={}):
#         fc_feats = torch.mean(att_feats, dim=1)
        ...
        if beam_size > 1:
            return self._sample_beam(fc_feats, att_feats, box_logits, att_relscore, att_masks, opt)
