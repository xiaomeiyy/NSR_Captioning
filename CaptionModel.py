...
class CaptionModel(nn.Module):
    ...
    def constraint_beam_search(self, init_state, init_logprobs, *args, **kwargs):
        ...
        # def constraint_beam_step(logprobsf, unaug_logprobsf, beam_size, t, beam_seq, beam_seq_logprobs, beam_logprobs_sum, state):
        #     # INPUTS:
        #     # logprobsf: probabilities augmented after diversity
        #     # beam_size: obvious
        #     # t        : time instant
